<?php
	...
	$query = "select otd.quantity , otd.Product_TotalPay, p.product_name, p.product_image
	...
	class Order{
		...
		function __construct($quantity,$Product_TotalPay,$product_name,$product_image){
