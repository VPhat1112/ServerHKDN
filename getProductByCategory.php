<?php
    ...
    $query = "SELECT product.* from product left join category on category.id=product.category_id where product.category_id=$idcategory and product.status='1' Order BY ID DESC";
